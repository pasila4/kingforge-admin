    ...
    const query = useQuery({
        ...
        queryFn: async () => {
            if (type === "state") {
                ...
                return results.map(
                    (r: { id: string; name: string; stateName: string }): LocationSearchItem => ({
                        id: r.id,
                        label: r.name,
                ...
                return results.map(
                    (r: { id: string; name: string; districtName: string; stateName: string }): LocationSearchItem => ({
                        id: r.id,
                        label: r.name,
                ...
                return results.map(
                    (r: { id: string; name: string; mandalName: string; districtName: string; stateName: string }): LocationSearchItem => ({
                        id: r.id,
                        label: r.name,
